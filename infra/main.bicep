...
module api './app/api.bicep' = {
  ...
  params: {
    ...
    allowedOrigins: [ web.outputs.SERVICE_WEB_URI, 'http://localhost:3000' ]
    appSettings: {
      AZURE_COSMOS_CONNECTION_STRING_KEY: cosmosDB.outputs.connectionStringKey
    }
  }
}
